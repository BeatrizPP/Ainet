...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">Ainet Print Management</a>
    </div>
    <!-- Top Menu Items -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="{{ URL::route('requestCreateEdit') }}"><i class="fa fa-print" aria-hidden="true"></i> New Print Request</a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
